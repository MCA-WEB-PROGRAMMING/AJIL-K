    ...
    if(isset($_POST["ssubmit"]))
    {
        ...
        if ($result->num_rows > 0)
        {
            ...
            while($row = $result->fetch_assoc())
            {
                ...
                echo"<tr><td>Phone</td><td>" . $row["title"]."</td></tr>";
                echo"<tr><td>email ID</td><td>" . $row["author"]."</td></tr>";
                echo"<tr><td>Username</td><td>" . $row["edition"]."</td></tr>";
                echo"<tr><td>Password</td><td>" . $row["publisher"]."</td></tr>";
                echo"</table>";
            }
        }
        else
